...
\item Defínase la función aritmética
    \begin{equation*}
        ...
        \end{cases}
    \end{equation*}
y sea $n_0 \in \mathbb{N}$ arbitrario pero fijo. Se tiene que la función aritmética $g$ deifnida como $g(r) = \eta_r(n_0), \forall r \in \mathbb{N}$, es multiplicativa. En efecto, si $r,s \in \mathbb{N}$ son tales que $(r,s)=1$, entonces
\begin{equation*}
