...
\centering
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[black, only marks, mark options={fill=black}, ycomb, mark size=1.5pt] table [col sep=comma] {plots/plot7.csv};
            \addplot[black, line width=1pt] coordinates {(-30,9) (30,9)};
            \addplot[black, line width=1pt] coordinates {(-30,-9) (30,-9)};
        \end{axis}
    \end{tikzpicture}
\label{fig:even}
