...
\centering
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[black, only marks, mark options={fill=black}, mark size=0.8pt] table [col sep=comma] {plots/phi.csv};
            \addplot[black, line width=1pt] coordinates {(0-10,996+20) (1e3+10,996+20)};
        \end{axis}
    \end{tikzpicture}
\label{fig:phi}
\end{figure}
