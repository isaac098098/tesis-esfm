...
%Layout
\usepackage[left=3.0cm,right=3.0cm,top=3.0cm,bottom=3.3cm,headheight=0.8cm,asymmetric]{geometry} %page size
...
\titleformat{\section}[display]{\normalfont\Large\bfseries \sffamily}{\textsc{\chaptername\ } \thesection}{15pt}{\huge}
...
\addto{\captionsspanish}{\renewcommand{\contentsname}{\bfseries \sffamily Índice general \vspace{15pt}}} %babel, toc title format
...
\renewcommand{\cftsecpagefont}{\sffamily} %section entry number format
\renewcommand{\cftsubsecfont}{\sffamily} %subsection entry format
\renewcommand{\cftsubsecpagefont}{\sffamily} %subsection entry number format
