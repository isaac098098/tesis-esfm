...
\centering
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[black, only marks, mark options={fill=black}, ycomb, mark size=0.8pt] table [col sep=comma] {plots/plot8.csv};
            \addplot[black, line width=1pt] coordinates {(-101,-0.5) (101,-0.5)};
            \addplot[black, line width=1pt] coordinates {(-101,1.5) (101,1.5)};
        \end{axis}
    \end{tikzpicture}
\label{fig:signal}
\end{figure}
